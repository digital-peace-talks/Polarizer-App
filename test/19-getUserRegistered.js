...
function getUserRegisteredTest(publicKey)
//-------------------------------------------
    ...
    describe('request', function()
    {
        ...
        it('should send string', async function()
        {
            ...
            await socket.emit("api",
            {
				...
				path: '/user/registered/', // siehe DTP-openapi
            ...
            if(restObj.method == 'post')
            {
                if(restObj.path == '/user/login/')
                {
					...
					if(restObj.data.message == 'logged in')
                    {
						...
						//------------------------------------------
						getUserRegisteredTest('publicKey'); // aufruf der function (args siehe DPT-openapi) 
						//-----------------------------------------
...
console.log("publicKey " + dptcookie);
