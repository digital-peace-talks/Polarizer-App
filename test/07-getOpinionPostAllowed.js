...
function getOpinionPostAllowedTest(topicId) {
  //-------------------------------------------
  ...
  describe("request", function () {
    it("should send string", async function () {
      await socket.emit("api", {
        ...
        path: "/opinion/postAllowed/", // siehe DTP-openapi
        data: {
          topicId: topicId,
          //---------------------------------------
        },
        ...
        if (restObj.method == "post") {
          if (restObj.path == "/user/login/") {
            ...
            if (restObj.data.message == "logged in") {
              ...
              //------------------------------------------
              getOpinionPostAllowedTest(topicId); // aufruf der function (args siehe DPT-openapi)
              //-----------------------------------------
            }
