    ...
    var i = function (o, r) {
      ...
      if (
        ...
        (i.svgPath = i.doc.querySelector("base")
          ...
          : ""),
        0 === a("#" + s, i.doc).length && d !== !1)
      ) {
        if (null == d) {
          for (
            var c = n.getElementsByTagName("script"), u = 0;
            u < c.length;
            u += 1
          ) {
            var g = c[u].src,
              f = g.match("trumbowyg(.min)?.js");
            null != f && (d = g.substring(0, g.indexOf(f[0])) + "icons.svg");
          }
          null == d &&
        ...
        (h.id = s),
          i.doc.body.insertBefore(h, i.doc.body.childNodes[0]),
          a.ajax({
            async: !0,
            type: "GET",
            ...
            complete: null,
            success: function (e) {
              h.innerHTML = new XMLSerializer().serializeToString(
                e.documentElement
              );
            },
          });
      ...
      (i.btnsDef = {
        ...
        h5: { fn: "formatBlock", title: p + " 5" },
        h6: { fn: "formatBlock", title: p + " 6" },
        subscript: { tag: "sub" },
        superscript: { tag: "sup" },
        bold: { key: "B", tag: "b" },
        italic: { key: "I", tag: "i" },
    ...
    i.prototype = {
      ...
      buildEditor: function () {
        ...
        e.$ed
          ...
          a(e.doc.body).on("keydown", function (t) {
      ...
      semanticTag: function (e, t) {
        ...
        a(e, this.$ed).each(function () {
          ...
          return (
            ...
            (e.wrap("<" + n + "/>"),
            t &&
              a.each(e.prop("attributes"), function () {
      ...
      createLink: function () {
        ...
        o.saveRange();
        var u = {
          url: { label: "URL", required: !0, value: e },
        ...
        try {
          ...
          try {
            ...
            "insertHorizontalRule" === e
              ? (t = void 0)
              : "formatBlock" === e && o.isIE && (t = "<" + t + ">"),
              o.doc.execCommand(e, !1, t),
              o.syncCode(),
              o.semanticCode(!1, !0);
          }
          "dropdown" !== e &&
            (o.updateButtonPaneStatus(), o.$c.trigger("tbwchange"));
        }
      },
