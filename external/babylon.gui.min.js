...
***************************************************************************** */
          ...
          h = (function () {
            ...
            return (
              ...
              (t.prototype.transformToRef = function (t, e) {
                for (
                  var i = s.Polygon.Rectangle(
                      this.left,
                      this.top,
                      this.left + this.width,
                      this.top + this.height
                    ),
                    r = new s.Vector2(Number.MAX_VALUE, Number.MAX_VALUE),
                    n = new s.Vector2(0, 0),
                    o = 0;
                  o < 4;
                  o++
                )
                  t.transformCoordinates(i[o].x, i[o].y, i[o]),
                    (r.x = Math.floor(Math.min(r.x, i[o].x))),
                    (r.y = Math.floor(Math.min(r.y, i[o].y))),
                    (n.x = Math.ceil(Math.max(n.x, i[o].x))),
                    (n.y = Math.ceil(Math.max(n.y, i[o].y)));
                (e.left = r.x),
                  (e.top = r.y),
                  (e.width = n.x - r.x),
                  (e.height = n.y - r.y);
          ...
          c = (function () {
            function t(e) {
              (this.name = e),
                ...
                (this._isDirty = !0),
                (this._wasDirty = !1),
                (this._tempParentMeasure = h.Empty()),
                (this._prevCurrentMeasureTransformedIntoGlobalSpace = h.Empty()),
                (this._cachedParentMeasure = h.Empty()),
                ...
                (this._transformMatrix = u.Identity()),
                (this._invertTransformMatrix = u.Identity()),
                ...
                (this._tmpMeasureA = new h(0, 0, 0, 0));
            }
            return (
              ...
              (t.prototype._clip = function (e, i) {
                ...
                if (
                  ...
                  e.rect(
                    ...
                    t._ClipMeasure.top + u,
                    t._ClipMeasure.width + l - a,
                    t._ClipMeasure.height + c - u
                  );
                } else
                  e.rect(
                    t._ClipMeasure.left,
              ...
              (t.prototype._processPicking = function (t, e, i, r, n) {
                return (
                  ...
                  !!this.contains(t, e) &&
                  (this._processObservables(i, t, e, r, n), !0)
                );
              }),
          ...
          return (
                    ...
                    h._tempParentMeasure.copyFrom(this._measureForChildren),
                      h._layout(this._measureForChildren, e) &&
                        (this.adaptWidthToChildren &&
                          h._width.isPixel &&
                          (r = Math.max(r, h._currentMeasure.width)),
                        this.adaptHeightToChildren &&
                          h._height.isPixel &&
                          (n = Math.max(n, h._currentMeasure.height)));
                  }
                  this.adaptWidthToChildren &&
                    r >= 0 &&
                    this.width !== r + "px" &&
            ...
            (e.prototype._processPicking = function (e, i, r, n, o) {
              ...
              for (var s = this._children.length - 1; s >= 0; s--) {
                ...
                if (a._processPicking(e, i, r, n, o))
                  return (
                    a.hoverCursor && this._host._changeCursor(a.hoverCursor), !0
                  );
              }
              return (
                !!this.isHitTestVisible &&
                this._processObservables(r, e, i, n, o)
              );
            }),
        ...
        var p = (function (t) {
          function e(e, i) {
            ...
            return (
              (r.name = e),
              (r._text = ""),
              (r._textWrapping = d.Clip),
              (r._textHorizontalAlignment = c.HORIZONTAL_ALIGNMENT_CENTER),
              (r._textVerticalAlignment = c.VERTICAL_ALIGNMENT_CENTER),
              (r._resizeToFit = !1),
          ...
          return (
            ...
            (e.prototype._processMeasures = function (e, i) {
              this._fontOffset || (this._fontOffset = c._GetFontOffset(i.font)),
                t.prototype._processMeasures.call(this, e, i),
            ...
            (e.prototype._breakLines = function (t, e) {
              ...
              else if (this._textWrapping === d.WordWrap)
            ...
            (e.prototype.computeExpectedHeight = function () {
              if (this.text && this.widthInPixels) {
                ...
                if (t) {
                  this._applyStates(t),
                    this._fontOffset ||
                      (this._fontOffset = c._GetFontOffset(t.font));
                  var e = this._lines
                      ? this._lines
                      : this._breakLines(
                          this.widthInPixels -
          ...
          return (
              ...
              if (i && i.documentElement) {
                ...
                if (r && n && o) {
                  ...
                  s.transform &&
                    ...
                    this.onSVGAttributesComputedObservable.notifyObservers(
                      this
                    );
                }
              }
            ...
            (e.prototype._renderNinePatch = function (t) {
              ...
              this._populateNinePatchSlicesFromImage &&
                ...
                (n -= 1),
                (o -= 1));
              var h = this._sliceRight - this._sliceLeft + 1,
              ...
              this._renderCornerPatch(t, s, a, i, r, 0, 0),
                ...
                this._drawImage(
                  ...
                  this._sliceTop,
                  h,
                  this._sliceBottom - this._sliceTop + 1,
          ...
          return (
            ...
            (e.prototype._processPicking = function (e, i, r, n, o) {
              ...
              if (this.delegatePickingToChildren) {
                for (var s = !1, a = this._children.length - 1; a >= 0; a--) {
            ...
            (e.CreateImageButton = function (t, i, r) {
              var n = new e(t),
                o = new p(t + "_button", i);
              (o.textWrapping = !0),
                (o.textHorizontalAlignment = c.HORIZONTAL_ALIGNMENT_CENTER),
                (o.paddingLeft = "20%"),
                n.addControl(o);
              var s = new g(t + "_icon", r);
              return (
                (s.width = "20%"),
                (s.stretch = g.STRETCH_UNIFORM),
                (s.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                n.addControl(s),
                (n._image = s),
                (n._textBlock = o),
                n
            ...
            (e.CreateImageOnlyButton = function (t, i) {
              var r = new e(t),
                n = new g(t + "_icon", i);
              return (
                (n.stretch = g.STRETCH_FILL),
                (n.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                r.addControl(n),
                (r._image = n),
                r
              );
            ...
            (e.CreateSimpleButton = function (t, i) {
              ...
              return (
                (n.textWrapping = !0),
                (n.textHorizontalAlignment = c.HORIZONTAL_ALIGNMENT_CENTER),
                r.addControl(n),
                (r._textBlock = n),
                r
              );
            ...
            (e.CreateImageWithCenterTextButton = function (t, i, r) {
              ...
              return (
                (s.textWrapping = !0),
                (s.textHorizontalAlignment = c.HORIZONTAL_ALIGNMENT_CENTER),
                n.addControl(s),
                (n._image = o),
                (n._textBlock = s),
                n
          ...
          return (
            ...
            (e.prototype._preMeasure = function (e, i) {
              for (var r = 0, n = this._children; r < n.length; r++) {
                var o = n[r];
                this._isVertical
                  ? (o.verticalAlignment = c.VERTICAL_ALIGNMENT_TOP)
                  : (o.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT);
              }
            ...
            (e.prototype._postMeasure = function () {
              ...
              if (!this._manualHeight && this._isVertical) {
                ...
                (this.height = i + "px"),
                  (h =
                    l !== this.height || !this._height.ignoreAdaptiveScaling);
              }
          ...
          return (
            ...
            (e.prototype._draw = function (t) {
              ...
              if (
                ...
                t.fillRect(
                  this._currentMeasure.left + this._thickness / 2 + (e - r) / 2,
                  this._currentMeasure.top + this._thickness / 2 + (i - n) / 2,
                  r,
                  n
                );
              }
            ...
            (e.AddCheckBoxWithHeader = function (t, i) {
              ...
              return (
                ...
                (o.width = "180px"),
                (o.paddingLeft = "5px"),
                (o.textHorizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                (o.color = "white"),
                r.addControl(o),
                r
              );
          ...
          return (
              ...
              if (
                ...
                if (
                  ...
                  if (this._isTextHighlightOn)
                    ...
                    this.text =
                      this._text.slice(0, o) + e + this._text.slice(o);
                  }
              }
            }),
            ...
            (e.prototype._draw = function (t) {
              ...
              this._isFocused ||
                ...
                ((r = this._placeholderText),
                this._placeholderColor &&
                  (t.fillStyle = this._placeholderColor)),
                (this._textWidth = t.measureText(r).width);
              var n =
                2 *
                this._margin.getValueInPixel(
                  this._host,
              ...
              if (
                ...
                t.clip(),
                this._isFocused && this._textWidth > s)
              ) {
                var a = i - this._textWidth + s;
                this._scrollLeft || (this._scrollLeft = a);
              } else this._scrollLeft = i;
              if (
                (t.fillText(r, this._scrollLeft, this._currentMeasure.top + o),
                this._isFocused)
              ) {
                if (this._clickedCoordinate) {
                  ...
                  var u = 0;
                  do {
                    this._cursorOffset && (u = Math.abs(h - l)),
                      this._cursorOffset++,
                      (l = t.measureText(
                        r.substr(
                          r.length - this._cursorOffset,
                          this._cursorOffset
                        )
                      ).width);
                  } while (l < h && r.length >= this._cursorOffset);
                  Math.abs(h - l) > u && this._cursorOffset--,
                    (this._blinkIsEven = !1),
                    (this._clickedCoordinate = null);
                }
                if (!this._blinkIsEven) {
                  ...
                  f < i
                    ? ((this._scrollLeft += i - f),
                      (f = i),
                      this._markAsDirty())
                    : f > i + s &&
                      ((this._scrollLeft += i + s - f),
                      (f = i + s),
                      this._markAsDirty()),
                    this._isTextHighlightOn ||
                      t.fillRect(
        ...
        var O = (function (t) {
          ...
          return (
            ...
            (e.prototype.setRowDefinition = function (t, e, i) {
              ...
              return r && r.isPixel === i && r.internalValue === e
                ? this
            ...
            (e.ShowPickerDialogAsync = function (t, i) {
              return new Promise(function (r, n) {
                ...
                function Z(t, e) {
                  ...
                  if (
                    ((k.background = i),
                    y.name != A && (y.text = Math.floor(255 * t.r).toString()),
                    C.name != A && (C.text = Math.floor(255 * t.g).toString()),
                    T.name != A && (T.text = Math.floor(255 * t.b).toString()),
                    w.name != A && (w.text = t.r.toString()),
                    x.name != A && (x.text = t.g.toString()),
                ...
                function $() {
                  if (i.savedColors && i.savedColors[d]) {
                    ...
                    var r = s.Color3.FromHexString(i.savedColors[d]),
                      n = r.r + r.g + r.b;
                    (e.color = n > X ? Y : U),
                      (e.fontSize = Math.floor(0.7 * D)),
                      (e.textBlock.verticalAlignment =
                        c.VERTICAL_ALIGNMENT_CENTER),
                      (e.height = e.width = D.toString() + "px"),
                      (e.background = i.savedColors[d]),
                      (e.thickness = 2);
                    var o = d;
                    return (
                      ...
                      e.onPointerClickObservable.add(function () {
                        ...
                        K
                          ? ((t = o),
                            ...
                            et("", Nt))
                          : i.savedColors &&
                            Z(s.Color3.FromHexString(i.savedColors[o]), e.name);
                      }),
                      e
                    );
                  }
                ...
                function et(t, e) {
                  if (i.savedColors) {
                    ...
                    if (g.rowCount != r + n) {
                      for (var o = g.rowCount, s = 0; s < o; s++)
                        g.removeRowDefinition(0);
                      for (s = 0; s < r + n; s++)
                        s % 2
                          ? g.addRowDefinition(D, !0)
                          : g.addRowDefinition(R, !0);
                    }
                    g.height = (D * r + n * R).toString() + "px";
                ...
                function it(t) {
                  t
                    ? (((h = b.CreateSimpleButton(
                      ...
                      (h.verticalAlignment = c.VERTICAL_ALIGNMENT_BOTTOM),
                      (h.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                      (h.thickness = 2),
                      (h.color = V),
                      (h.fontSize = a),
                      (h.background = H),
                ...
                function rt(t, e) {
                  e
                    ? ((t.color = W), (t.background = G))
                    : ((t.color = V), (t.background = H));
                }
                function nt(e) {
                ...
                var ot = new O();
                if (
                  ((ot.name = "Dialog Container"),
                  (ot.width = i.pickerWidth),
                  i.savedColors)
                ) {
                  ot.height = B;
                ...
                if ((t.addControl(ot), i.savedColors)) {
                  ((g = new O()).name = "Swatch Drawer"),
                    (g.verticalAlignment = c.VERTICAL_ALIGNMENT_TOP),
                    (g.background = H),
                    (g.width = i.pickerWidth);
                  var at = i.savedColors.length / i.numSwatchesPerLine;
                  if (0 == at) var ht = 0;
                  else ht = at + 1;
                  (g.height = (D * at + ht * R).toString() + "px"),
                    (g.top = Math.floor(0.25 * D).toString() + "px");
                  for (
                    var lt = 0;
                    lt <
                    ...
                    lt % 2 != 0
                      ? g.addRowDefinition(D, !0)
                      : g.addRowDefinition(R, !0);
                  for (lt = 0; lt < 2 * i.numSwatchesPerLine + 1; lt++)
                    lt % 2 != 0
                      ? g.addColumnDefinition(D, !0)
                      : g.addColumnDefinition(R, !0);
                  ot.addControl(g, 1, 0);
                }
                var ut = new O();
                ...
                var ct = parseInt(i.headerHeight) / parseInt(i.pickerHeight),
                  _t = [ct, 1 - ct];
                ut.addRowDefinition(_t[0], !1),
                  ut.addRowDefinition(_t[1], !1),
                  ot.addControl(ut, 0, 0);
                var dt = new f();
                (dt.name = "Dialogue Header Bar"),
                  (dt.background = "#cccccc"),
                  (dt.thickness = 0),
                  ut.addControl(dt, 0, 0);
                var ft = b.CreateSimpleButton("closeButton", "a");
                ft.fontFamily = "BabylonJSglyphs";
                var pt = s.Color3.FromHexString(dt.background);
                (o = new s.Color3(1 - pt.r, 1 - pt.g, 1 - pt.b)),
                  (ft.color = o.toHexString()),
                  (ft.fontSize = Math.floor(0.6 * parseInt(i.headerHeight))),
                  (ft.textBlock.textVerticalAlignment =
                    c.VERTICAL_ALIGNMENT_CENTER),
                  (ft.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_RIGHT),
                  (ft.height = ft.width = i.headerHeight),
                  (ft.background = dt.background),
                  (ft.thickness = 0),
                  (ft.pointerDownAnimation = function () {}),
                  (ft.pointerUpAnimation = function () {
                    ft.background = dt.background;
                  }),
                ...
                var bt = [0.4375, 0.5625];
                gt.addRowDefinition(1, !1),
                  gt.addColumnDefinition(bt[0], !1),
                  gt.addColumnDefinition(bt[1], !1),
                  ut.addControl(gt, 1, 0);
                var mt = new O();
                (mt.name = "Picker Grid"),
                  mt.addRowDefinition(0.85, !1),
                  mt.addRowDefinition(0.15, !1),
                  gt.addControl(mt, 0, 0),
                  ((m = new e()).name = "GUI Color Picker"),
                  i.pickerHeight < i.pickerWidth
                    ? (m.width = 0.89)
                    : (m.height = 0.89),
                  (m.value = s.Color3.FromHexString(i.lastColor)),
                  (m.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_CENTER),
                  (m.verticalAlignment = c.VERTICAL_ALIGNMENT_CENTER),
                  ...
                  mt.addControl(m, 0, 0);
                var yt = new O();
                (yt.name = "Dialogue Right Half"),
                  (yt.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT);
                var vt = [0.514, 0.486];
                yt.addRowDefinition(vt[0], !1),
                  yt.addRowDefinition(vt[1], !1),
                  gt.addControl(yt, 1, 1);
                var Ot = new O();
                Ot.name = "Swatches and Buttons";
                var Ct = [0.417, 0.583];
                Ot.addRowDefinition(1, !1),
                  Ot.addColumnDefinition(Ct[0], !1),
                  Ot.addColumnDefinition(Ct[1], !1),
                  yt.addControl(Ot, 0, 0);
                var Tt = new O();
                Tt.name = "New and Current Swatches";
                var wt = [0.04, 0.16, 0.64, 0.16];
                Tt.addRowDefinition(wt[0], !1),
                  Tt.addRowDefinition(wt[1], !1),
                  Tt.addRowDefinition(wt[2], !1),
                  Tt.addRowDefinition(wt[3], !1),
                  Ot.addControl(Tt, 0, 0);
                var xt = new O();
                (xt.name = "Active Swatches"),
                  (xt.width = 0.67),
                  xt.addRowDefinition(0.5, !1),
                  xt.addRowDefinition(0.5, !1),
                  Tt.addControl(xt, 2, 0);
                var Pt = Math.floor(
                    parseInt(i.pickerWidth) * bt[1] * Ct[0] * 0.11
                  ),
                  Mt = Math.floor(
                    parseInt(i.pickerHeight) * _t[1] * vt[0] * wt[1] * 0.5
                  );
                if (i.pickerWidth > i.pickerHeight) var kt = Mt;
                else kt = Pt;
                var It = new p();
                (It.text = "new"),
                  (It.name = "New Color Label"),
                  (It.color = V),
                  (It.fontSize = kt),
                  Tt.addControl(It, 1, 0),
                  ((k = new f()).name = "New Color Swatch"),
                  (k.background = i.lastColor),
                  (k.thickness = 0),
                  xt.addControl(k, 0, 0);
                var At = b.CreateSimpleButton("currentSwatch", "");
                (At.background = i.lastColor),
                  (At.thickness = 0),
                  At.onPointerClickObservable.add(function () {
                    Z(s.Color3.FromHexString(At.background), At.name), tt(!1);
                  }),
                  (At.pointerDownAnimation = function () {}),
                  (At.pointerUpAnimation = function () {}),
                  (At.pointerEnterAnimation = function () {}),
                  (At.pointerOutAnimation = function () {}),
                  xt.addControl(At, 1, 0);
                var St = new f();
                (St.name = "Swatch Outline"),
                  (St.width = 0.67),
                  (St.thickness = 2),
                  (St.color = "#404040"),
                  (St.isHitTestVisible = !1),
                  Tt.addControl(St, 2, 0);
                var Et = new p();
                (Et.name = "Current Color Label"),
                  (Et.text = "current"),
                  (Et.color = V),
                  (Et.fontSize = kt),
                  Tt.addControl(Et, 3, 0);
                var Rt = new O();
                (Rt.name = "Button Grid"), (Rt.height = 0.8);
                Rt.addRowDefinition(1 / 3, !1),
                  Rt.addRowDefinition(1 / 3, !1),
                  Rt.addRowDefinition(1 / 3, !1),
                  Ot.addControl(Rt, 0, 1),
                  (l =
                    Math.floor(
                      parseInt(i.pickerWidth) * bt[1] * Ct[1] * 0.67
                    ).toString() + "px"),
                  (u =
                    Math.floor(
                      parseInt(i.pickerHeight) *
                        _t[1] *
                        vt[0] *
                        (parseFloat(Rt.height.toString()) / 100) *
                        (1 / 3) *
                        0.7
                    ).toString() + "px"),
                  (a =
                ...
                var Lt = b.CreateSimpleButton("butOK", "OK");
                (Lt.width = l),
                  (Lt.height = u),
                  (Lt.verticalAlignment = c.VERTICAL_ALIGNMENT_CENTER),
                  (Lt.thickness = 2),
                  (Lt.color = V),
                  (Lt.fontSize = a),
                  (Lt.background = H),
                  Lt.onPointerEnterObservable.add(function () {
                    Lt.background = F;
                  }),
                  ...
                  Rt.addControl(Lt, 0, 0);
                var Dt = b.CreateSimpleButton("butCancel", "Cancel");
                if (
                  ((Dt.width = l),
                  (Dt.height = u),
                  (Dt.verticalAlignment = c.VERTICAL_ALIGNMENT_CENTER),
                  (Dt.thickness = 2),
                  (Dt.color = V),
                  (Dt.fontSize = a),
                  (Dt.background = H),
                  Dt.onPointerEnterObservable.add(function () {
                    Dt.background = F;
                  }),
                  ...
                  Rt.addControl(Dt, 1, 0),
                  i.savedColors)
                ) {
                  var Nt = b.CreateSimpleButton("butSave", "Save");
                  (Nt.width = l),
                    (Nt.height = u),
                    (Nt.verticalAlignment = c.VERTICAL_ALIGNMENT_CENTER),
                    (Nt.thickness = 2),
                    (Nt.fontSize = a),
                    i.savedColors.length < i.swatchLimit
                      ? ((Nt.color = V), (Nt.background = H))
                      : rt(Nt, !0),
                    Nt.onPointerEnterObservable.add(function () {
                      i.savedColors &&
                        i.savedColors.length < i.swatchLimit &&
                        (Nt.background = F);
                    }),
                    ...
                    Nt.onPointerClickObservable.add(function () {
                      i.savedColors &&
                        (0 == i.savedColors.length && it(!0),
                        i.savedColors.length < i.swatchLimit &&
                          et(k.background, Nt),
                        tt(!1));
                    }),
                    i.savedColors.length > 0 && it(!0),
                    Rt.addControl(Nt, 2, 0);
                }
                var Bt = new O();
                (Bt.name = "Dialog Lower Right"),
                  Bt.addRowDefinition(0.02, !1),
                  Bt.addRowDefinition(0.63, !1),
                  Bt.addRowDefinition(0.21, !1),
                  Bt.addRowDefinition(0.14, !1),
                  yt.addControl(Bt, 1, 0),
                  (_ = s.Color3.FromHexString(i.lastColor));
                var Vt = new O();
                (Vt.name = "RGB Values"),
                  (Vt.width = 0.82),
                  (Vt.verticalAlignment = c.VERTICAL_ALIGNMENT_CENTER),
                  Vt.addRowDefinition(1 / 3, !1),
                  Vt.addRowDefinition(1 / 3, !1),
                  Vt.addRowDefinition(1 / 3, !1),
                  Vt.addColumnDefinition(0.1, !1),
                  Vt.addColumnDefinition(0.2, !1),
                  Vt.addColumnDefinition(0.7, !1),
                  Bt.addControl(Vt, 1, 0);
                for (lt = 0; lt < q.length; lt++) {
                  ((Ht = new p()).text = q[lt]),
                    (Ht.color = V),
                    (Ht.fontSize = a),
                    Vt.addControl(Ht, lt, 0);
                }
                ((y = new v()).width = 0.83),
                  (y.height = 0.72),
                  (y.name = "rIntField"),
                  (y.fontSize = a),
                  (y.text = (255 * _.r).toString()),
                  (y.color = "#f0f0f0"),
                  (y.background = "#454545"),
                  ...
                  (w.color = "#f0f0f0"),
                  (w.background = "#454545"),
                  w.onFocusObservable.add(function () {
                    (A = w.name), (I = w.text), tt(!1);
                  }),
                  w.onBlurObservable.add(function () {
                    (0 != parseFloat(w.text) && "" != w.text) ||
                      ((w.text = "0"), Q(w, "r")),
                      A == w.name && (A = "");
                  }),
                  ...
                  (x.color = "#f0f0f0"),
                  (x.background = "#454545"),
                  x.onFocusObservable.add(function () {
                    (A = x.name), (I = x.text), tt(!1);
                  }),
                  x.onBlurObservable.add(function () {
                    (0 != parseFloat(x.text) && "" != x.text) ||
                      ((x.text = "0"), Q(x, "g")),
                      A == x.name && (A = "");
                  }),
                ...
                (Ft.name = "Hex Value"),
                  (Ft.width = 0.82),
                  Ft.addRowDefinition(1, !1),
                  Ft.addColumnDefinition(0.1, !1),
                  Ft.addColumnDefinition(0.9, !1),
                  Bt.addControl(Ft, 2, 0),
                  ((Ht = new p()).text = "#"),
                  (Ht.color = V),
                  (Ht.fontSize = a),
                  Ft.addControl(Ht, 0, 0),
                  ((M = new v()).width = 0.96),
                  (M.height = 0.72),
                  (M.name = "hexField"),
                  (M.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_CENTER),
                ...
                (M.text = jt[1]),
                  ...
                  M.onBlurObservable.add(function () {
                    ...
                    "" == M.text &&
                      ((M.text = "000000"),
                      Z(s.Color3.FromHexString(M.text), "b")),
                      A == M.name && (A = "");
                  }),
                  M.onTextChangedObservable.add(function () {
                    ...
                    if ((M.text.length > 6 || e) && A == M.name) M.text = I;
                      ...
                      (t = "#" + t),
                        A == M.name &&
                          ((I = M.text), Z(s.Color3.FromHexString(t), M.name));
                    }
                  }),
                  Ft.addControl(M, 0, 1),
                  i.savedColors && i.savedColors.length > 0 && et("", Nt);
              });
            }),
            (e._Epsilon = 1e-6),
            e
        ...
        var x = (function (t) {
          function e(e) {
            ...
            return (
              ...
              (i._horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
              (i._verticalAlignment = c.VERTICAL_ALIGNMENT_TOP),
              i
            );
          }
          return (
          ...
          M = (function (t) {
            ...
            return (
              ...
              (e.prototype.getAt = function (t) {
                return (
                  this._points[t] || (this._points[t] = new P(this)),
                  this._points[t]
                );
              }),
              ...
              (e.prototype._draw = function (t) {
                ...
                this._points.forEach(function (i) {
                  i &&
                    (e
                      ? (t.moveTo(i._point.x, i._point.y), (e = !1))
                      : t.lineTo(i._point.x, i._point.y));
                }),
                  t.stroke(),
                  t.restore();
              }),
          ...
          return (
            ...
            (e.AddRadioButtonWithHeader = function (t, i, r, n) {
              ...
              return (
                ...
                (a.width = "180px"),
                (a.paddingLeft = "5px"),
                (a.textHorizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                (a.color = "white"),
                o.addControl(a),
                o
              );
              ...
              (e.prototype._draw = function (t) {
                ...
                this.isThumbClamped && this.isThumbCircle
                  ? (this.isVertical
                      ...
                      : (e += this._effectiveThumbThickness / 2),
                    (o = this._backgroundBoxThickness / 2))
                  : (o =
                ...
                (t.fillStyle = this._background),
                  this.isVertical
                    ? this.isThumbClamped
                      ? this.isThumbCircle
                        ? (t.beginPath(),
                          t.arc(
                            e + this._backgroundBoxThickness / 2,
                            i,
                            o,
                            Math.PI,
                            2 * Math.PI
                          ...
                          t.fill(),
                          t.fillRect(e, i, r, n))
                        : t.fillRect(e, i, r, n + this._effectiveThumbThickness)
                      : t.fillRect(e, i, r, n)
                    : this.isThumbClamped
                    ? this.isThumbCircle
                      ? (t.beginPath(),
                        t.arc(
                          e + this._backgroundBoxLength,
                        ...
                        t.fill(),
                        t.fillRect(e, i, r, n))
                      : t.fillRect(e, i, r + this._effectiveThumbThickness, n)
                    : t.fillRect(e, i, r, n),
                  (this.shadowBlur ||
                    this.shadowOffsetX ||
                    this.shadowOffsetY) &&
                      ...
                      ? this.isThumbClamped
                        ? this.isThumbCircle
                          ? (t.beginPath(),
                            ...
                            t.fill(),
                            t.fillRect(e, i + s, r, n - s))
                          : t.fillRect(
                              e,
                              i + s,
                              r,
                              n - s + this._effectiveThumbThickness
                            )
                        : t.fillRect(e, i + s, r, n - s)
                      : this.isThumbClamped && this.isThumbCircle
                      ? (t.beginPath(),
                  ...
                  this.displayThumb &&
                    ...
                    this._isThumbCircle
                      ...
                      : (this.isVertical
                          ? t.fillRect(
                              e - this._effectiveBarOffset,
                              this._currentMeasure.top + s,
                              this._currentMeasure.width,
                              this._effectiveThumbThickness
                            )
                          : t.fillRect(
                              this._currentMeasure.left + s,
                              this._currentMeasure.top,
                              this._effectiveThumbThickness,
                              this._currentMeasure.height
                            ),
        ...
        var S = (function () {
            function t(t) {
              (this.name = t),
                (this._groupPanel = new m()),
                (this._selectors = new Array()),
                (this._groupPanel.verticalAlignment = c.VERTICAL_ALIGNMENT_TOP),
                (this._groupPanel.horizontalAlignment =
                  c.HORIZONTAL_ALIGNMENT_LEFT),
            ...
            return (
              ...
              (t.prototype._addGroupHeader = function (t) {
                ...
                return (
                  ...
                  (e.textWrapping = !0),
                  (e.color = "black"),
                  (e.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                  (e.textHorizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                  (e.left = "2px"),
            ...
            return (
              ...
              (e.prototype.addCheckbox = function (t, e, i) {
                ...
                (r.width = "20px"),
                  ...
                  (r.color = "#364249"),
                  (r.background = "#CCCCCC"),
                  (r.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                  r.onIsCheckedChangedObservable.add(function (t) {
                    e(t);
                  });
                var n = c.AddHeader(r, t, "200px", {
                  isHorizontal: !0,
                  controlFirst: !0,
                });
                (n.height = "30px"),
            ...
            return (
              ...
              (e.prototype.addSlider = function (t, e, i, r, n, o, s) {
                ...
                (a.name = i),
                  ...
                  (a.background = "#CCCCCC"),
                  (a.borderColor = "black"),
                  (a.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                  (a.left = "4px"),
                  (a.paddingBottom = "4px"),
                ...
                var h = c.AddHeader(a, t + ": " + s(o) + " " + i, "30px", {
                  isHorizontal: !1,
                  controlFirst: !1,
                });
                (h.height = "60px"),
          ...
          D = (function (t) {
            function e(e, i) {
              ...
              if (
                ...
                (r.thickness = 2),
                (r._panel = new m()),
                (r._panel.verticalAlignment = c.VERTICAL_ALIGNMENT_TOP),
                (r._panel.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                (r._panel.top = 5),
                (r._panel.left = 5),
                (r._panel.width = 0.95),
                i.length > 0)
            ...
            return (
              ...
              (e.prototype._addSpacer = function () {
                ...
                (t.width = 1),
                  ...
                  (t.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT);
                var e = new f();
                (e.width = 1),
                  (e.height = this._barHeight),
                  (e.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                  (e.verticalAlignment = c.VERTICAL_ALIGNMENT_CENTER),
            ...
            return (
              ...
              (e.prototype._postMeasure = function () {
                for (
                  ...
                  o.isVisible &&
                    !o.notRenderable &&
                    (o.horizontalAlignment === c.HORIZONTAL_ALIGNMENT_CENTER &&
                      o._offsetLeft(
                        this._currentMeasure.left - o._currentMeasure.left
                      ),
                    o.verticalAlignment === c.VERTICAL_ALIGNMENT_CENTER &&
                      o._offsetTop(
            ...
            return (
              ...
              (e.prototype._draw = function (t) {
                ...
                (t.fillStyle = this._background),
                  ...
                  (t.fillStyle = this.color),
                  this.isVertical
                    ? ((this._thumbMeasure.left = e - this._effectiveBarOffset),
                      (this._thumbMeasure.top = this._currentMeasure.top + i),
                      (this._thumbMeasure.width = this._currentMeasure.width),
                      (this._thumbMeasure.height = this._effectiveThumbThickness))
                    : ((this._thumbMeasure.left =
                        this._currentMeasure.left + i),
                  ...
                  t.fillRect(
                    this._thumbMeasure.left,
                    this._thumbMeasure.top,
                    this._thumbMeasure.width,
                    this._thumbMeasure.height
                  ),
                  t.restore();
              }),
              (e.prototype._updateValueFromPointer = function (t, e) {
                0 != this.rotation &&
                  ...
                  this._first &&
                    ...
                    (this._originX = t),
                    (this._originY = e),
                    (t < this._thumbMeasure.left ||
                      t > this._thumbMeasure.left + this._thumbMeasure.width ||
                      e < this._thumbMeasure.top ||
                      e > this._thumbMeasure.top + this._thumbMeasure.height) &&
                      (this.isVertical
                        ? (this.value =
                            this.minimum +
                            (1 -
          ...
          V = (function (t) {
            function e(e) {
              ...
              return (
                (i._barSize = 20),
                (i._pointerIsOver = !1),
                (i._wheelPrecision = 0.05),
                i.onDirtyObservable.add(function () {
                  (i._horizontalBarSpace.color = i.color),
                    (i._verticalBarSpace.color = i.color),
                    (i._dragSpace.color = i.color);
                }),
                ...
                (i._grid = new O()),
                (i._horizontalBar = new B()),
                (i._verticalBar = new B()),
                (i._window = new N()),
                (i._window.horizontalAlignment = c.HORIZONTAL_ALIGNMENT_LEFT),
                (i._window.verticalAlignment = c.VERTICAL_ALIGNMENT_TOP),
                i._grid.addColumnDefinition(1),
                i._grid.addColumnDefinition(0, !0),
                i._grid.addRowDefinition(1),
                i._grid.addRowDefinition(0, !0),
                t.prototype.addControl.call(i, i._grid),
                i._grid.addControl(i._window, 0, 0),
                (i._verticalBar.paddingLeft = 0),
                (i._verticalBar.width = "100%"),
                (i._verticalBar.height = "100%"),
                (i._verticalBar.barOffset = 0),
                (i._verticalBar.value = 0),
                (i._verticalBar.maximum = 1),
                (i._verticalBar.horizontalAlignment =
                  c.HORIZONTAL_ALIGNMENT_CENTER),
                (i._verticalBar.verticalAlignment =
                  c.VERTICAL_ALIGNMENT_CENTER),
                (i._verticalBar.isVertical = !0),
                (i._verticalBar.rotation = Math.PI),
                (i._verticalBar.isVisible = !1),
                (i._verticalBarSpace = new f()),
                (i._verticalBarSpace.horizontalAlignment =
                  c.HORIZONTAL_ALIGNMENT_LEFT),
                (i._verticalBarSpace.verticalAlignment =
                  c.VERTICAL_ALIGNMENT_TOP),
                (i._verticalBarSpace.thickness = 1),
                i._grid.addControl(i._verticalBarSpace, 0, 1),
                i._verticalBarSpace.addControl(i._verticalBar),
                i._verticalBar.onValueChangedObservable.add(function (t) {
                  i._window.top = t * i._endTop + "px";
                }),
                (i._horizontalBar.paddingLeft = 0),
                (i._horizontalBar.width = "100%"),
                (i._horizontalBar.height = "100%"),
                (i._horizontalBar.barOffset = 0),
                (i._horizontalBar.value = 0),
                (i._horizontalBar.maximum = 1),
                (i._horizontalBar.horizontalAlignment =
                  c.HORIZONTAL_ALIGNMENT_CENTER),
                (i._horizontalBar.verticalAlignment =
                  c.VERTICAL_ALIGNMENT_CENTER),
                (i._horizontalBar.isVisible = !1),
                (i._horizontalBarSpace = new f()),
                (i._horizontalBarSpace.horizontalAlignment =
                  c.HORIZONTAL_ALIGNMENT_LEFT),
                (i._horizontalBarSpace.verticalAlignment =
                  c.VERTICAL_ALIGNMENT_TOP),
                (i._horizontalBarSpace.thickness = 1),
                i._grid.addControl(i._horizontalBarSpace, 1, 0),
                i._horizontalBarSpace.addControl(i._horizontalBar),
                i._horizontalBar.onValueChangedObservable.add(function (t) {
                  i._window.left = t * i._endLeft + "px";
                }),
                (i._dragSpace = new f()),
                (i._dragSpace.thickness = 1),
                i._grid.addControl(i._dragSpace, 1, 1),
                (i.barColor = "grey"),
                (i.barBackground = "transparent"),
                i
              );
            }
            return (
              ...
              (e.prototype._buildClientSizes = function () {
                (this._window.parentClientWidth =
                  this._currentMeasure.width -
                  (this._verticalBar.isVisible ? this._barSize : 0) -
                  2 * this.thickness),
                  (this._window.parentClientHeight =
                    this._currentMeasure.height -
                    (this._horizontalBar.isVisible ? this._barSize : 0) -
                    2 * this.thickness),
              ...
              Object.defineProperty(e.prototype, "barBackground", {
                ...
                set: function (t) {
                  this._barBackground !== t &&
                    ((this._barBackground = t),
                    (this._horizontalBar.background = t),
                    (this._verticalBar.background = t),
              ...
              (e.prototype._updateScroller = function () {
                ...
                this._horizontalBar.isVisible && t <= this._clientWidth
                  ...
                  : !this._horizontalBar.isVisible &&
                    ...
                    (this._rebuildLayout = !0)),
                  this._verticalBar.isVisible && e <= this._clientHeight
                    ...
                    : !this._verticalBar.isVisible &&
                      ...
                      (this._rebuildLayout = !0)),
                  this._buildClientSizes(),
                  (this._endLeft = this._clientWidth - t),
                  (this._endTop = this._clientHeight - e);
                var i = this._horizontalBar.value * this._endLeft + "px",
                  r = this._verticalBar.value * this._endTop + "px";
                i !== this._window.left &&
                  ((this._window.left = i), (this._rebuildLayout = !0)),
                  r !== this._window.top &&
                    ((this._window.top = r), (this._rebuildLayout = !0));
                var n = this._clientWidth / t,
                  o = this._clientHeight / e;
                (this._horizontalBar.thumbWidth = this._clientWidth * n + "px"),
                  (this._verticalBar.thumbWidth =
                    this._clientHeight * o + "px");
              }),
              (e.prototype._link = function (e) {
              ...
              (e.prototype._attachWheel = function () {
                ...
                if (this._host && !this._onPointerObserver) {
                  ...
                  this._onPointerObserver = e.onPointerObservable.add(function (
                    e,
                    i
                  ) {
                    t._pointerIsOver &&
                      e.type === s.PointerEventTypes.POINTERWHEEL &&
                      (1 == t._verticalBar.isVisible &&
                        (e.event.deltaY < 0 && t._verticalBar.value > 0
              ...
              (e.prototype.dispose = function () {
                var e = this._host.getScene();
                e &&
                  this._onPointerObserver &&
                  (e.onPointerObservable.remove(this._onPointerObserver),
              ...
              if ((t.save(), this._applyStates(t), this._isEnabled)) {
                ...
                if (this._displayMinorLines) {
                  ...
                  for (var o = -e / 2; o < e / 2; o++) {
                    ...
                    t.beginPath(),
                      t.moveTo(s, this._currentMeasure.top),
                      t.lineTo(
                        s,
                        this._currentMeasure.top + this._currentMeasure.height
                      ),
                  ...
                  for (var a = -i / 2; a < i / 2; a++) {
                    var h = n + a * this.cellHeight;
                    t.beginPath(),
                      t.moveTo(this._currentMeasure.left, h),
                      t.lineTo(
                        this._currentMeasure.left + this._currentMeasure.width,
                        h
                      ),
                ...
                if (this._displayMajorLines) {
                  ...
                  for (
                    o = -e / 2 + this._majorLineFrequency;
                    o < e / 2;
                    o += this._majorLineFrequency
                  ) {
                  ...
                  for (
                    a = -i / 2 + this._majorLineFrequency;
                    a < i / 2;
                    a += this._majorLineFrequency
                  ) {
                    h = n + a * this.cellHeight;
                    t.moveTo(this._currentMeasure.left, h),
                      t.lineTo(
                        this._currentMeasure.left + this._currentMeasure.width,
                        h
        ...
        var W = (function (t) {
          function e(e) {
            var i = t.call(this, e) || this;
            return (i.name = e), (i._tempMeasure = new h(0, 0, 0, 0)), i;
          }
          return (
            n(e, t),
            Object.defineProperty(e.prototype, "displayThumb", {
                  ...
                  (this.isVertical
                    ? this.isThumbClamped && this.displayThumb
                      ? this._tempMeasure.copyFromFloats(
                          ...
                          r + e,
                          n,
                          o - e + this._effectiveThumbThickness
                        )
                      : this._tempMeasure.copyFromFloats(i, r + e, n, o - e)
                    : this.isThumbClamped && this.displayThumb
                    ? this._tempMeasure.copyFromFloats(
                        i,
                        r,
                    ...
                    : this._tempMeasure.copyFromFloats(i, r, e, o),
        ...
        var G = (function () {
          ...
          z = (function (t) {
            function e(e, i, r, n, o, a) {
              ...
              return (
                (l._isDirty = !1),
                (l._rootContainer = new _("root")),
                (l._lastControlOver = {}),
                (l._lastControlDown = {}),
                (l._capturingControl = {}),
                (l._linkedControls = new Array()),
                (l._isFullscreen = !1),
                (l._fullscreenViewport = new s.Viewport(0, 0, 1, 1)),
                (l._idealWidth = 0),
                (l._idealHeight = 0),
                (l._useSmallestIdeal = !1),
                (l._renderAtIdealSize = !1),
                (l._blockNextFocusCheck = !1),
                (l._renderScale = 1),
                (l._cursorChanged = !1),
                (l._clipboardData = ""),
                (l.onClipboardObservable = new s.Observable()),
                (l.onControlPickedObservable = new s.Observable()),
                (l.onBeginLayoutObservable = new s.Observable()),
                (l.onEndLayoutObservable = new s.Observable()),
                (l.onBeginRenderObservable = new s.Observable()),
                (l.onEndRenderObservable = new s.Observable()),
                (l.premulAlpha = !1),
                (l._useInvalidateRectOptimization = !0),
                (l._invalidatedRectangle = null),
                (l._clearMeasure = new h(0, 0, 0, 0)),
                (l.onClipboardCopy = function (t) {
                  var e = t,
                    i = new s.ClipboardInfo(s.ClipboardEventTypes.COPY, e);
                  l.onClipboardObservable.notifyObservers(i),
                    e.preventDefault();
                }),
                ...
                (n = l.getScene()) && l._texture
                  ? ((l._rootElement = n.getEngine().getInputElement()),
                    (l._renderObserver = n.onBeforeCameraRenderObservable.add(
                      function (t) {
                        return l._checkUpdate(t);
                      }
                    )),
                    (l._preKeyboardObserver = n.onPreKeyboardObservable.add(
                      function (t) {
                        l._focusedControl &&
                          (t.type === s.KeyboardEventTypes.KEYDOWN &&
                            l._focusedControl.processKeyboard(t.event),
                          (t.skipOnPointerObservable = !0));
                      }
                    )),
                    l._rootContainer._link(l),
                    (l.hasAlpha = !0),
                    (i && r) ||
                      ((l._resizeObserver = n
                        .getEngine()
            ...
            return (
              ...
              (e.prototype.invalidateRect = function (t, e, i, r) {
                if (this._useInvalidateRectOptimization)
                  if (this._invalidatedRectangle) {
                    ...
                    this._invalidatedRectangle = new h(
                      t,
                      e,
                      i - t + 1,
                      r - e + 1
              ...
              (e.prototype.getProjectedPosition = function (t, e) {
                ...
                return (
                  n.scaleInPlace(this.renderScale), new s.Vector2(n.x, n.y)
                );
              }),
                      ...
                      if (o.isVisible) {
                        ...
                        if (a && !a.isDisposed()) {
                          var h = a.getBoundingInfo
                              ? a.getBoundingInfo().boundingSphere.center
                          ...
                          l.z < 0 || l.z > 1
                            ? (o.notRenderable = !0)
                            : ((o.notRenderable = !1),
                              l.scaleInPlace(this.renderScale),
                              o._moveToProjectedPosition(l));
                        } else
              ...
              (e.prototype._doPicking = function (t, e, i, r, n) {
                ...
                if (o) {
                  ...
                  if (this._isFullscreen) {
                    var l = (o.cameraToUseForPointers || o.activeCamera)
                      .viewport;
                    (t *= h.width / (a.getRenderWidth() * l.width)),
                      (e *= h.height / (a.getRenderHeight() * l.height));
                  }
                  this._capturingControl[r]
                    ...
                    : ((this._cursorChanged = !1),
                      this._rootContainer._processPicking(t, e, i, r, n) ||
                        (this._changeCursor(""),
            ...
            return (
              ...
              (t.prototype._createGuiElement = function (t, e, i) {
                ...
                try {
                  ...
                  if (this._nodes[t.attributes.getNamedItem("id").nodeValue])
                    throw "XmlLoader Exception : Duplicate ID, every element should have an unique ID attribute";
                  return (
                    (this._nodes[
                      t.attributes.getNamedItem("id").nodeValue
                    ] = r),
                    r
                  );
                } catch (e) {
          ...
          q = (function () {
            ...
            return (
              ...
              (t.prototype.removeBehavior = function (t) {
                ...
                return -1 === e
                  ? this
                  : (this._behaviors[e].detach(),
                    this._behaviors.splice(e, 1),
                    this);
              }),
          ...
          Q = (function (t) {
            function e() {
              ...
              return (
                ...
                (e._rows = 0),
                (e._rowThenColum = !0),
                (e._orientation = J.FACEORIGIN_ORIENTATION),
                (e.margin = 0),
                e
              );
            }
          ...
          rt = (function (t) {
            ...
            return (
              ...
              (e.prototype.isReadyForSubMesh = function (t, e, i) {
                if (this.isFrozen && this._wasPreviouslyReady && e.effect)
                  return !0;
                e._materialDefines || (e._materialDefines = new it());
                var r = this.getScene(),
        ...
        var nt = (function (t) {
            ...
            return (
              ...
              Object.defineProperty(e.prototype, "text", {
                ...
                set: function (t) {
                  this._text !== t &&
                    ((this._text = t), this._rebuildContent());
                },
                enumerable: !0,
                configurable: !0,
              }),
          ...
          ut = (function () {
            function t(t) {
              ...
              (this._lastControlOver = {}),
                ...
                (this._rootContainer = new J("RootContainer")),
      ...
      function (t, e, i) {
        ...
        i.r(e),
          function (t) {
            ...
            void 0 !== n &&
              ((n.BABYLON = n.BABYLON || {}), (n.BABYLON.GUI = r));
          }.call(this, i(3));
      },
      function (t, e) {
        var i;
